...
# installed.
TK_PREFIX='/opt/uClinux/bfin-linux-uclibc'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/opt/uClinux/bfin-linux-uclibc'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/src/packages/BUILD/blackfin-toolchain-08r1.5/binutils_build/tk/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/opt/uClinux/bfin-linux-uclibc/lib -ltk8.4'
...
# compiled.
TK_SRC_DIR='/usr/src/packages/BUILD/binutils-2.17/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/src/packages/BUILD/blackfin-toolchain-08r1.5/binutils_build/tk/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/opt/uClinux/bfin-linux-uclibc/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/src/packages/BUILD/blackfin-toolchain-08r1.5/binutils_build/tk/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/opt/uClinux/bfin-linux-uclibc/lib/libtkstub8.4.a'
