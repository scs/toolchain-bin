...
# installed.
TK_PREFIX='/home/oscar/data/new_uclinux/toolchain/build-uclinux'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/oscar/data/new_uclinux/toolchain/build-uclinux'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib -ltk8.4'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib -ltkstub8.4'
...
TK_STUB_LIB_PATH='/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib/libtkstub8.4.a'
