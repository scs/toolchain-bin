...
# installed.
TCL_PREFIX='/opt/uClinux/bfin-uclinux'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/uClinux/bfin-uclinux'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/uClinux/bfin-uclinux/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/uClinux/bfin-uclinux/include'
...
TCL_PACKAGE_PATH='/opt/uClinux/bfin-uclinux/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/uClinux/bfin-uclinux/lib -ltclstub8.4${TCL_DBGX}'
...
TCL_STUB_LIB_PATH='/opt/uClinux/bfin-uclinux/lib/libtclstub8.4${TCL_DBGX}.a'
