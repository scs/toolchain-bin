...
# installed.
TCL_PREFIX='/home/oscar/data/new_uclinux/toolchain/build-uclinux'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/oscar/data/new_uclinux/toolchain/build-uclinux'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/oscar/data/new_uclinux/toolchain/build-uclinux/include'
...
TCL_PACKAGE_PATH='/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib -ltclstub8.4${TCL_DBGX}'
...
TCL_STUB_LIB_PATH='/home/oscar/data/new_uclinux/toolchain/build-uclinux/lib/libtclstub8.4${TCL_DBGX}.a'
